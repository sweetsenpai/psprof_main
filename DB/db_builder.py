...
class Categories(db.Model):
    ...
    category_id = db.Column(name='category_id', type_=db.Integer, primary_key=True, onupdate="cascade")
    ...
    view = db.Column(autoincrement=True,name='view', type_=db.Integer)
